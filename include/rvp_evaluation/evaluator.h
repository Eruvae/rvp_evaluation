...
#include "rvp_evaluation/point_cloud_color_handler_clusters.h"
...
{
private:
  std::shared_ptr<OctreeProviderInterface> planner;
...
public:
  Evaluator(std::shared_ptr<OctreeProviderInterface> planner, ros::NodeHandle &nh, ros::NodeHandle &nhp,
